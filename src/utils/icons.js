export const home = <i className="fa-solid fa-chart-line"></i>;
...
export const travel = <i class="fa fa-plane" aria-hidden="true"></i>;
export const minus = <i class="fa fa-minus-square-o" aria-hidden="true"></i>;
